...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" version="1.0" exclude-result-prefixes="sitemap">  
  ...
  <!-- Set variables for whether lastmod, changefreq or priority occur for any url in the sitemap. We do this up front because it can be expensive in a large sitemap. -->  
  ...
  <xsl:template match="/"> 
    <html lang="zh-CN"> 
      <head> 
        <title>网站地图-{$web_array["name"]}</title>  
      ...
      <body> 
        <div id="sitemap"> 
          <div id="sitemap__header"> 
            <h1>XML站点地图</h1>  
            <p>此XML站点地图是由JieAdmin生成的，以使您的内容在搜索引擎中更加可见。</p>  
            <p>
              <a href="https://www.sitemaps.org/">了解有关XML站点地图的更多信息。</a>
            </p> 
          </div>  
          <div id="sitemap__content"> 
            <p class="text">此XML站点地图中的URL数：
